...
SECRET_KEY = "django-insecure-j$y*v4b%^ip98cgjz!^srl^va2o0k3bb-p)5sll(4*x$pavi8c"
...
INSTALLED_APPS = [
    ...
    "algoritmo_categorizacion.apps.AlgoritmoCategorizacionConfig",
    "manejo_app.apps.ManejoAppConfig",
]
